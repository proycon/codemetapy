...
setup(
    name = "CodeMetaPy",
    version = "2.3.2", #also adapt in codemeta.json
    ...
    install_requires=[ 'nameparser','importlib_metadata','BeautifulSoup4', 'rdflib >= 6.1.1','pyshacl', 'requests','lxml','pyyaml','Jinja2','pep517'],
